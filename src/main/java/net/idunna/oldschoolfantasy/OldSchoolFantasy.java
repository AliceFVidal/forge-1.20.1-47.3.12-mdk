...
@Mod(net.idunna.oldschoolfantasy.OldSchoolFantasy.MOD_ID)
public class OldSchoolFantasy {
    // Define mod id in a common place for everything to reference
    public static final String MOD_ID = "oldschoolfantasy";
    // Directly reference a slf4j logger
    private static final Logger LOGGER = LogUtils.getLogger();

    public OldSchoolFantasy(FMLJavaModLoadingContext context) {
